  ...
  function areNodesEqual(node1: ts.Node, node2: ts.Node): boolean {
    ...
    switch (node1.kind) {
      ...
      case ts.SyntaxKind.PropertyDeclaration:
        ...
        return areNodesEqual(prop1.name, prop2.name) && 
               (prop1.type && prop2.type ? areNodesEqual(prop1.type, prop2.type) : prop1.type === prop2.type);
    ...
    return children1.every((child, index) => areNodesEqual(child, children2[index]));
  }
